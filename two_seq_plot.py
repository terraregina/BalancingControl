...
for l in lst:
    ...
    for util in utility:
        ...
        fname = 'figs/'+ l[-1] + '_'
        fname += '_'.join(['two_context','switch', str(int(l[0])), 'degr', str(int(l[1])),\
    ...
    fname = 'figs/'+ l[-1] + '_'
    fname += '_'.join(['two_deval','switch', str(int(l[0])), 'degr', str(int(l[1])),\
            'learn', str(int(l[2])), 'q', str(l[3]),\
            'p', str(l[4]),'dec', str(l[8]),'util', '-'.join([str(u) for u in util])]) + '.png'
    ...
    # plt.figure()
        ...
        fname += '_'.join(['two_dkl','switch', str(int(l[0])), 'degr', str(int(l[1])),\
                'learn', str(int(l[2])), 'q', str(l[3]),\
                'p', str(l[4]),'dec', str(l[8]),'util', '-'.join([str(u) for u in util])]) + '.png'
